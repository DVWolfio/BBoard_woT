...
/*
@WebServlet("/GetRespondList")
public class GetRespondListServlet extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
//        super.doGet(req, resp);
        System.out.println("GetRespondList_GET");
...
//        super.doPost(req, resp);
        System.out.println("-----------[GetRespondList_POST]-----------");
